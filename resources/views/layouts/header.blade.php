                    ...
                    <div class="mainmenu">
                        <ul id="slicknav-menu-list">
                            ...
                            <li><a href="#">Thông tin</a>
                                <ul>
                                    <li><a href="car-booking.html">Điểm đến</a></li>
                                    <li><a href="car-list.html">Danh sách xe</a></li>
                                    <!-- <li><a href="car-details.html">Car Details</a></li> -->
                                    <!-- <li><a href="flight-home.html">Flight Home</a></li>
                                    <li><a href="flight-booking.html">Flight Booking</a></li> -->
                                    <li><a href="flight-details.html">Danh sách chuyến bay</a></li>
                                    <!-- <li><a href="hotel-list.html">Hotel List</a></li> -->
                                    <li><a href="hotel-details.html">Danh sách khách sạn</a></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <p>Hành trình khám phá và tận hưởng các vùng đất mới. Đặt tours và đi thôi</p>
                            <a href="tours.html" class="pink-btn">Xem tất cả Tours</a>
                        </div>
                    </div>
                </div>
            </div>
