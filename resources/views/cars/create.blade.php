...
@section('content')
    <form class="form" method="POST" action="{{route('car.store')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control"
                           placeholder="Input name car...." value="{{old('name')}}">
                </div>
                <div class="form-group">
                    <label>Star</label>
                ...
                <div class="form-group">
                    ...
                    <input name="cary_bag" type="number" class="form-control"
                           placeholder="">
                </div>
                <div class="form-group">
                    <label>Date:</label>
